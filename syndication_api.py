...
def home():
    ...
    r = sess.get('http://localhost/article/meta/100')
...
def feed():
    ...
    for article in r:
        ...
        comment_tags = sess.get("http://localhost/tags/searchTag/"+ str(article['title'].replace(" ","%20")))
        ...
        comment_count = sess.get("http://localhost/comments/count/"+ str(article['title'].replace(" ","%20"))).text
...
def comment():
    ...
    articles = sess.get('http://localhost/article/meta/100')
    ...
    for article in articles:
        ...
        article_comments = sess.get("http://localhost/comments/retrieve/"+ str(article['title'].replace(" ","%20")) + "/100")
